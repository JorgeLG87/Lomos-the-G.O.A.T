...
function CartProvider({ children }) {
    ...
    function getProductBeverage(id) {
        if (id === "price_1QBDqDAspxlK0TBsmuFK3fGa" || id === "price_1QAWMLAspxlK0TBs40YVjWnR" || id === "3" || id === "4" || id === "5" || id === "6") {
    ...
    function getLettuceInstruction(id) {
        if (id === "price_1QBDqDAspxlK0TBsmuFK3fGa" || id === "price_1QAWMLAspxlK0TBs40YVjWnR" || id === "price_1QBE39AspxlK0TBsWQEup4F1" || id === "price_1QU9xZAspxlK0TBsdnAwLgx7" || id === "5" || id === "6" || id === "7" || id === "8") {
